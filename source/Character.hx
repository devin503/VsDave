...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
		...
		switch (curCharacter)
		{
			...
			case 'ralph':
			var tex = Paths.getSparrowAtlas('sevenfootframe');
			frames = tex;
			animation.addByPrefix('idle', 'BF idle dance', 24, false);
			animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
			animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			addOffset('idle', -5);
			addOffset("singUP", -108, 16);
			addOffset("singRIGHT", -124, -5);
			addOffset("singLEFT", -87, -11);
			addOffset("singDOWN", -93, 5);
			addOffset("singUPmiss", -106, 83);
			addOffset("singRIGHTmiss", -134, 30);
			addOffset("singLEFTmiss", -53, 31);
			addOffset("singDOWNmiss", -87, 48);
			addOffset("hey", -17);
			addOffset('firstDeath', -35, 2);
			addOffset('deathLoop', -47, 3);
			addOffset('deathConfirm', -47, 79);
			addOffset('scared', -14);
			...
			case 'nextor':
			var tex = Paths.getSparrowAtlas('RalphTest');
			frames = tex;
			animation.addByPrefix('idle', 'BF idle dance', 24, false);
			animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
			animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			addOffset('idle', -5);
			addOffset("singUP", -103, 2);
			addOffset("singRIGHT", -123, -6);
			addOffset("singLEFT", -105, -9);
			addOffset("singDOWN", -127, 9);
			addOffset("singUPmiss", -101, 66);
			addOffset("singRIGHTmiss", -138, 28);
			addOffset("singLEFTmiss", -113, 23);
			addOffset("singDOWNmiss", -122, 25);
			addOffset("hey", -23, -1);
			addOffset('firstDeath', -25, 18);
			addOffset('deathLoop', -29, -18);
			addOffset('deathConfirm', -28, 56);
			addOffset('scared', -14);
